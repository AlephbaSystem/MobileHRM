...
namespace MobileHRM.Controls.Behaviors
{
    public class LongPressBehavior : Behavior<ImageButton>
    {
        ...
        protected override void OnAttachedTo(ImageButton imageButton)
        {
            base.OnAttachedTo(imageButton);
            this.BindingContext = imageButton.BindingContext;
            imageButton.Pressed += Button_Pressed;
            imageButton.Released += Button_Released;
        }

        protected override void OnDetachingFrom(ImageButton imageButton)
        {
